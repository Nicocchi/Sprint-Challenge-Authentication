...
## Project Description - User Management System - JokesList On YoU!
...
- In order to be able to access our Killer JokesList you'll need to implement a User Authentication System that uses bcrypt and JWT.
...
- Add a React client that connects to your API and has pages for `Sign Up`, `Sign In` and showing a list of `JokesList`.
